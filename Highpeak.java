...
public class Highpeak {
    ...
    public static void main(String[] args) {
    	try
    	{
            ...
            FileWriter fw = new FileWriter("C:\\Users\\DELL\\Desktop\\KodNest Projects\\output.txt");
            
            fw.write("Number of Employees"+ M);
            fw.write("\n");
            ...
            fw.write("And the difference between the chosen goodies with highest price and the lowest price is:"+result);
